...
const STRINGS = {
  ...
  'update.available': 'LiveMark {version} is available',
  'update.brewDetail': 'Installed via Homebrew',
  'update.actionInstall': 'Update & Restart',
  'update.actionCopyBrew': 'Copy brew upgrade command',
  'update.brewCopied': 'Copied · run it in a terminal',
  'update.downloading': 'Downloading… {percent}%',
  'update.installing': 'Installing…',
  'update.upToDate': 'LiveMark is up to date ({version})',
